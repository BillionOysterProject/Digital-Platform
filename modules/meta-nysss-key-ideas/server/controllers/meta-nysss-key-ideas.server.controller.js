...
exports.create = function (req, res) {
  var standard = new MetaNysssKeyIdea(req.body);
...
exports.list = function (req, res) {
  ...
  if (req.query.searchString) {
    try {
      ...
      query = MetaNysssKeyIdea.find({ $or: [{ 'header': searchRe }, { 'description': searchRe }] });
    } catch(e) {
      return res.status(400).send({
...
exports.standardByID = function (req, res, next, id) {
  ...
  MetaNysssKeyIdea.findById(id).exec(function (err, standard) {
    if (err) {
      return next(err);
    } else if (!standard) {
