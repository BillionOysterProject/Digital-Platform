...
exports.create = function (req, res) {
  var standard = new MetaNgssScienceEngineeringPractice(req.body);
...
exports.list = function (req, res) {
  ...
  if (req.query.searchString) {
    try {
      ...
      query = MetaNgssScienceEngineeringPractice.find({ $or: [{ 'header': searchRe }, { 'description': searchRe }] });
    } catch(e) {
      return res.status(400).send({
    ...
    query = MetaNgssScienceEngineeringPractice.find();
  }
...
exports.standardByID = function (req, res, next, id) {
  ...
  MetaNgssScienceEngineeringPractice.findById(id).exec(function (err, standard) {
    if (err) {
      return next(err);
    } else if (!standard) {
