...
exports.create = function (req, res) {
  var standard = new MetaNysssMajorUnderstanding(req.body);
...
exports.list = function (req, res) {
  ...
  if (req.query.searchString) {
    try {
      ...
      query = MetaNysssMajorUnderstanding.find({ $or: [{ 'code': searchRe }, { 'description': searchRe }] });
    } catch(e) {
      return res.status(400).send({
    ...
    query = MetaNysssMajorUnderstanding.find();
  }
...
exports.standardByID = function (req, res, next, id) {
  ...
  MetaNysssMajorUnderstanding.findById(id).exec(function (err, standard) {
    if (err) {
      return next(err);
    } else if (!standard) {
