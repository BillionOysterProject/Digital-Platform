...
var validate = function(siteCondition, successCallback, errorCallback) {
  ...
  //  if (siteCondition) {
  //  if (!siteCondition.landConditions || !siteCondition.landConditions.garbage) {
  //    siteCondition.landConditions.garbage = {
  //      garbagePresent: false
  //    };
  //  }
  //  if (!siteCondition.landConditions || !siteCondition.landConditions.garbage ||
  //    !siteCondition.landConditions.garbage.garbagePresent) siteCondition.landConditions.garbage.garbagePresent = false;
  //  if (!siteCondition.waterConditions || !siteCondition.waterConditions.oilSheen) siteCondition.waterConditions.oilSheen = false;
  //  if (!siteCondition.waterConditions || !siteCondition.waterConditions.markedCombinedSewerOverflowPipes) {
  //    siteCondition.waterConditions.markedCombinedSewerOverflowPipes = {
  //      markedCSOPresent: false
  //    };
  //  }
  //  if (!siteCondition.waterConditions || !siteCondition.waterConditions.garbage) {
  //    siteCondition.waterConditions.garbage = {
  //      garbagePresent: false
  //    };
  //  }
  //  if (!siteCondition.waterConditions || !siteCondition.waterConditions.garbage ||
  //    !siteCondition.waterConditions.garbage.garbagePresent) siteCondition.waterConditions.garbage.garbagePresent = false;
  //  if (!siteCondition.waterConditions || !siteCondition.waterConditions.markedCombinedSewerOverflowPipes ||
  //    !siteCondition.waterConditions.markedCombinedSewerOverflowPipes.markedCSOPresent) siteCondition.waterConditions.markedCombinedSewerOverflowPipes.markedCSOPresent = false;
  //  if (!siteCondition.waterConditions || !siteCondition.waterConditions.unmarkedOutfallPipes) {
  //    siteCondition.waterConditions.unmarkedOutfallPipes = {
  //      unmarkedPipePresent: false
  //    };
  //  }
  //  if (!siteCondition.waterConditions || !siteCondition.waterConditions.unmarkedOutfallPipes ||
  //    !siteCondition.waterConditions.unmarkedOutfallPipes.unmarkedPipePresent) siteCondition.waterConditions.unmarkedOutfallPipes.unmarkedPipePresent = false;
  ...
  //    if (!siteCondition.meteorologicalConditions || !siteCondition.meteorologicalConditions.airTemperatureC) {
  //      errorMessages.push('Air temperature is required');
  //    }
  //    if(!siteCondition.meteorologicalConditions || emptyNumber(siteCondition.meteorologicalConditions.windSpeedMPH)) {
  //      errorMessages.push('Wind speed is required and must be positive');
  //    }
  //    if (!siteCondition.meteorologicalConditions || emptyString(siteCondition.meteorologicalConditions.windDirection)) {
  //      errorMessages.push('Wind direction is required');
  //    }
  //    if (!siteCondition.meteorologicalConditions || emptyNumber(siteCondition.meteorologicalConditions.humidityPer)) {
  ...
  //  }
  //  if (!siteCondition.tideConditions || emptyString(siteCondition.tideConditions.referencePoint)) {
  //    errorMessages.push('Reference point is required');
  //  }
  //  if (!siteCondition.tideConditions | emptyString(siteCondition.tideConditions.closestHighTide)) {
  //    errorMessages.push('Closest high tide time is required');
  //  } else {
  //    if (!siteCondition.tideConditions || !moment(siteCondition.tideConditions.closestHighTide).isValid()) {
  //      errorMessages.push('Tide Conditions - Closest High Tide Time is not valid');
  //    }
  //  }
  //  if (!siteCondition.tideConditions || emptyString(siteCondition.tideConditions.closestLowTide)) {
  ...
  //    }
  //  }
  //  if (!siteCondition.tideConditions || siteCondition.tideConditions.closestHighTideHeight === undefined) {
  //    errorMessages.push('Closest high tide height is required');
  //  }
  //  if (!siteCondition.tideConditions || siteCondition.tideConditions.closestLowTideHeight === undefined) {
  //    errorMessages.push('Closest low tide height is required');
  //  }
  //  if (!siteCondition.tideConditions || emptyString(siteCondition.tideConditions.tidalCurrent)) {
  ...
  //  }
  //  if (!siteCondition.waterConditions || emptyNumber(siteCondition.waterConditions.surfaceCurrentSpeedMPS)) {
  //    errorMessages.push('Surface current speed is required and must be positive');
  //  }
  //  if (!siteCondition.waterConditions || emptyString(siteCondition.waterConditions.waterColor)) {
  ...
  //  if (siteCondition.waterConditions && siteCondition.waterConditions.markedCombinedSewerOverflowPipes &&
  //    siteCondition.waterConditions.markedCombinedSewerOverflowPipes.markedCSOPresent === true) {
  ...
  //  if (siteCondition.waterConditions && siteCondition.waterConditions.unmarkedOutfallPipes &&
  //    siteCondition.waterConditions.unmarkedOutfallPipes.unmarkedPipePresent === true) {
  ...
  //  }
  //  if(!siteCondition.landConditions || !siteCondition.landConditions.shorelineSurfaceCoverEstPer ||
  //    emptyNumber(siteCondition.landConditions.shorelineSurfaceCoverEstPer.imperviousSurfacePer)) {
  ...
  //  }
  //  if (!siteCondition.landConditions || emptyString(siteCondition.landConditions.shoreLineType)) {
  //    errorMessages.push('Shore line type is required');
  //  }
  //  if (siteCondition.landConditions && siteCondition.landConditions.garbage &&
  //    siteCondition.landConditions.garbage.garbagePresent) {
  ...
  //    if (siteCondition.landConditions && siteCondition.landConditions.garage &&
  //      siteCondition.landConditions.garbage.other &&
