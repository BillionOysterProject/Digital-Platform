...
function seedTheTeam (team, leader, member, organization) {
  return new Promise(function (resolve, reject) {
    var Team = mongoose.model('Team');
...
module.exports.start = function start(options) {
  ...
  if (_.has(options, 'seedUserMember')) {
    seedOptions.seedUserMember = options.seedUserMember;
  }
  ...
  return new Promise(function (resolve, reject) {
    ...
    var memberAccount = new User(seedOptions.seedUserMember);
      ...
      seedTheOrganization(org)
        .then(function() {
          User.generateRandomPassphrase()
            ...
            .then(seedTheUser(memberAccount, org, 'P@$$w0rd!!'))
            .then(function () {
              seedTheTeam(team, leaderAccount, memberAccount, org)
                .then(function() {
                  resolve();
                })
                .catch(reportError(reject));
